...
namespace Flavor.Xmega32A4U_testBoard
{
    ...
    static class MC
    {
        ...
        enum Error: byte
        {
            ...
            Token = 255,    //Есть ошибка
            //ErrorNums...
            Decoder = 1,       //Такое команды не существует
        ...
        public class Counters
        {
            ...
            public static bool startMeasure(uint MILLISECONDS)
            {
                ...
                wDATA.Add((byte)Command.RTC.startMeasure); //Команда
                ...
                try
                {
                    if (rDATA[0] != (byte)Command.RTC.startMeasure)
                    {
            ...
            public static bool stopMeasure()
            {
                ...
                MC.Service.trace_attached(Environment.NewLine);
                MC.Service.trace(command);
                List<byte> rDATA = MC.Service.transmit((byte)Command.RTC.stopMeasure);
                try
                {
                    if (rDATA[0] != (byte)Command.RTC.stopMeasure)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return false;
                    }
            ...
            public static bool receiveResults()
            {
                ...
                rDATA = MC.Service.transmit((byte)Command.RTC.receiveResults);
                try
                {
                    if ((byte)Command.RTC.receiveResults != rDATA[0])
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return false;
                    }
        ...
        public static class Chip
        {
            ...
            public static bool checkCommandStack()
            {
                ...
                MC.Service.trace(command);
                List<byte> rDATA;
                rDATA = MC.Service.transmit((byte)Command.Service.checkCommandStack);
                try
                {
                    if (rDATA[0] != (byte)Command.Service.checkCommandStack)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return false;
                    }
            ...
            public static void getStatus()
            {
                ...
                MC.Service.trace_attached(Environment.NewLine);
                MC.Service.trace(command);
                List<byte> rDATA = MC.Service.transmit((byte)Command.Chip.getStatus);
                byte incedent;
                try
                {
                    if (rDATA[0] != (byte)Command.Chip.getStatus)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return;
                    }
            ...
            public static byte getVersion()
            {
                ...
                MC.Service.trace(command);
                List<byte> rDATA;
                rDATA = MC.Service.transmit((byte)Command.Chip.getVersion);
                try
                {
                    if (rDATA[0] != (byte)Command.Chip.getVersion)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
            ...
            private static byte receiveCommand(Command.Chip cmd, string name) {
                string command = cmd.ToString();
                MC.Service.trace_attached(Environment.NewLine);
                MC.Service.trace(command);
                List<byte> rDATA;
                rDATA = MC.Service.transmit((byte)cmd);
                try
                {
                    if (rDATA[0] != (byte)cmd)
                    {
                    ...
                    // Here command-specific action
                    MC.Service.trace(command + ": " + name + ": " + rDATA[1]);
                    return rDATA[1];
                }
                catch { MC.Service.addError(command + ": Ошибка данных!", rDATA); return byte.MaxValue; }
            }
            ...
            public static string getBirthday()
            {
                ...
                List<byte> rDATA = MC.Service.transmit((byte)Command.Chip.getBirthday);
                try
                {
                    if (rDATA[0] != (byte)Command.Chip.getBirthday)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return string.Empty;
                    }
            ...
            public static string getCPUfrequency()
            {
                ...
                MC.Service.trace(command);
                UInt32 frequency = 0;
                List<byte> rDATA = MC.Service.transmit((byte)Command.Chip.getCPUfrequency);
                try
                {
                    if (rDATA[0] != (byte)Command.Chip.getCPUfrequency)
                    {
                        MC.Service.addError(command + ": Ошибка отклика!", rDATA);
                        return string.Empty;
                    }
        ...
        public static class Service
        {
            ...
            static void showMeByte(byte BYTE)
            {
                ...
                wDATA.Add((byte)Command.Service.showMeByte);
                wDATA.Add(BYTE);
                    ...
                    case LAM.Tocken:
                        switch (DATA[1])
                        {
                            case LAM.RTC_end:
                                ...
                                trace(message);
                                if (Counters.MeasureEnd != null) { Counters.MeasureEnd(); }
                                break;
            ...
            public static List<byte> retransmit_toTIC(byte[] DATA)
            {
                ...
                data.Add((byte)Command.TIC.retransmit);
                data.AddRange(DATA);
                send(data);
        ...
        public static class Flags
        {
            ...
            public static string HVE
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.HVE);
                    try
                    {
            ...
            public static string PRGE
            {
                ...
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.PRGE, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    if (MC.Service.transmit((byte)Command.Flags.PRGE, setupByte)[1] == 254)
                    {
            ...
            public static string EDCD
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.EDCD, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    MC.Service.transmit((byte)Command.Flags.EDCD, setupByte);
                }
            }
            /// <summary>
            ...
            public static string SEMV1
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.SEMV1, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    MC.Service.transmit((byte)Command.Flags.SEMV1, setupByte);
                }
            }
            /// <summary>
            /// Включает\выключает вентиль
            ...
            public static string SEMV2
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.SEMV2, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    MC.Service.transmit((byte)Command.Flags.SEMV2, setupByte);
                }
            }
            /// <summary>
            /// Включает\выключает вентиль
            ...
            public static string SEMV3
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.SEMV3, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    MC.Service.transmit((byte)Command.Flags.SEMV3, setupByte);
                }
            }
            /// <summary>
            ...
            public static string SPUMP
            {
                get
                {
                    ...
                    MC.Service.trace_attached(Environment.NewLine);
                    MC.Service.trace(command);
                    List<byte> rDATA = MC.Service.transmit((byte)Command.Flags.SPUMP, 255);
                    try
                    {
                        switch (rDATA[1])
                        {
                ...
                set
                {
                    ...
                    MC.Service.transmit((byte)Command.Flags.SPUMP, setupByte);
                }
            }
        }
        #endregion
        ...
        static void wait()
        {
            ...
            byte[] wDATA = { (byte)Command.Chip.wait };
            USART.Open();
