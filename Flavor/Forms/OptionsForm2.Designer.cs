namespace Flavor.Forms {
    partial class OptionsForm2 {
        ...
        private void InitializeComponent() {
            ...
            0});
            // 
            // d2VoltageNumericUpDown
            // 
            resources.ApplyResources(this.d2VoltageNumericUpDown, "d2VoltageNumericUpDown");
            this.d2VoltageNumericUpDown.Maximum = new decimal(new int[] {
            3000,
            0,
            0,
            0});
            this.d2VoltageNumericUpDown.Minimum = new decimal(new int[] {
            2200,
            0,
            0,
            0});
            this.d2VoltageNumericUpDown.Name = "d2VoltageNumericUpDown";
            this.d2VoltageNumericUpDown.ReadOnly = true;
            this.d2VoltageNumericUpDown.Value = new decimal(new int[] {
            2700,
            0,
            0,
            0});
            // 
            // d1VoltageNumericUpDown
            // 
            resources.ApplyResources(this.d1VoltageNumericUpDown, "d1VoltageNumericUpDown");
            this.d1VoltageNumericUpDown.Maximum = new decimal(new int[] {
            3000,
            0,
            0,
            0});
            this.d1VoltageNumericUpDown.Minimum = new decimal(new int[] {
            2200,
            0,
            0,
            0});
            this.d1VoltageNumericUpDown.Name = "d1VoltageNumericUpDown";
            this.d1VoltageNumericUpDown.ReadOnly = true;
            this.d1VoltageNumericUpDown.Value = new decimal(new int[] {
            2700,
            0,
            0,
            0});
